...
PASOS_FINALES = (
    ...
    "renderizan con gen_minuta.py; Minuta y Definiciones SIEMPRE con --subtitulo "
    "\"Reunión del <fecha> · ~<duración> · <N> participantes\", y Definiciones "
    "además con --indice). "
    "Definiciones.md arranca directo en la primera seccion '##' tras el titulo (sin "
    "parrafos introductorios ni notas finales) y NO es un resumen: es el detalle "
